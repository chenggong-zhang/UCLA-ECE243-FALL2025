#!/usr/bin/env python3
"""
Quick batch size test - runs a single batch size configuration.
Usage: python quick_batch_test.py <batch_size>
Example: python quick_batch_test.py 96
"""
...
if len(sys.argv) < 2:
    print("Usage: python quick_batch_test.py <batch_size>")
    print("Example: python quick_batch_test.py 96")
    sys.exit(1)

batch_size = int(sys.argv[1])

modelName = f'speechTransformerCNN_SpecAug_LR0008_batch{batch_size}'
...
args['nBatch'] = 20000
args['nLayers'] = 8
args['scheduler_type'] = 'cosine_warmup'
